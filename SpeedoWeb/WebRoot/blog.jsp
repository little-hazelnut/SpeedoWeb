	...
	<div id="background">
		...
		<div id="navigation-div">
			<div id="inner-nav">
				<ul id="navigation">
					...
					<li class="li-blog selected"><a href="servlet/ListPicture">设计师作品</a></li>
		...
		<div id="page">
			<div id="contents">
				<div id="blogs">
					<ul class="items">
					<c:forEach items='${requestScope.pic}' var='list'>
					<li>
							<div class="pro-img">
								<a href="servlet/ShowPicItem?id=${list.pic.pictureId}">
									<img src="${list.pic.imgSrc }" alt="shirt" />
								</a>
							</div>
							<div class="pro-txt">
								<a href="servlet/ShowPicItem?id=${list.pic.pictureId}">${list.pic.pictureName }</a>
							</div>
							<div class="pro-price-men">
								设计师：${list.pic.userName}
							</div>
							<div class="work-score">
								评分：<span id="score">${list.score }</span>分
							</div>
						</li></c:forEach>
					...
					<div class="buttons">
						<div class="button-inner">
							<a href="imageswall/imageswall.html">更多作品</a> 
							<a href="diy-work.jsp">自己设计</a>
						</div> 
					</div>
					<div class="allpages">
						<a class="curpage" href="/SpeedoWeb/servlet/ListPicture?index=1">1</a>
						<a href="/SpeedoWeb/servlet/ListPicture?index=2">2</a>
						<a href="/SpeedoWeb/servlet/ListPicture?index=3">3</a>
						<a href="/SpeedoWeb/servlet/ListPicture?index=4">4</a>
						<a href="/SpeedoWeb/servlet/ListPicture?index=5">5</a>
						<a href="#">...</a>
